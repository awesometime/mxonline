...
class UserFavorite(models.Model):
    ...
    # todo 看一下具体ajax代码
    # 收藏ajax代码 org_base.html(js) & course-detail.html(js) & teacher-detail.html(js)
    # courses/views/CourseDetailView & organization/view/TeacherDetailView & organization/view/OrgHomeView
    # 前端提交ajax请求时会包含课程,机构,讲师对应的id存到fav_id,这个fav_id不是用户id
    # 机智版
    # 直接保存用户的id. ??? 为什么说是用户id
